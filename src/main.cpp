...
std::unordered_map<QString, int> syscallMap = {{"mount", SYS_mount},{"link", SYS_link}, {"linkat", SYS_linkat}, {"symlink", SYS_symlink}, {"symlinkat", SYS_symlinkat}, {"rename", SYS_rename}, {"renameat", SYS_renameat}, {"renameat2", SYS_renameat2}, {"open", SYS_open}, {"close", SYS_close}, {"stat", SYS_stat}, {"fstat", SYS_fstat}, {"lstat", SYS_lstat}, {"newfstatat", SYS_newfstatat}, {"access", SYS_access}, {"faccessat", SYS_faccessat}, {"faccessat2", SYS_faccessat2}, {"mkdir", SYS_mkdir}, {"mkdirat", SYS_mkdirat}, {"rmdir", SYS_rmdir}, {"creat", SYS_creat}, {"unlink", SYS_unlink}, {"unlinkat", SYS_unlinkat}, {"readlink", SYS_readlink}, {"readlinkat", SYS_readlinkat}, {"chmod", SYS_chmod}, {"fchmod", SYS_fchmod}, {"fchmodat", SYS_fchmodat}, {"chown", SYS_chown}, {"fchown", SYS_fchown}, {"lchown", SYS_lchown}, {"fchownat", SYS_fchownat}, {"chdir", SYS_chdir}, {"fchdir", SYS_fchdir}, {"statfs", SYS_statfs}, {"fstatfs", SYS_fstatfs}, {"umount2", SYS_umount2}, {"openat", SYS_openat}, {"openat2", SYS_openat2}, {"mknod", SYS_mknod}, {"mknodat", SYS_mknodat}, {"utimensat", SYS_utimensat}, {"futimesat", SYS_futimesat}, {"name_to_handle_at", SYS_name_to_handle_at}, {"open_by_handle_at", SYS_open_by_handle_at}, {"read", SYS_read}, {"write", SYS_write}, {"getdents", SYS_getdents}, {"getdents64", SYS_getdents64}, {"lseek", SYS_lseek}, {"fsync", SYS_fsync}, {"flock", SYS_flock}, {"sendfile", SYS_sendfile}};
...
std::unordered_map<QString, QStringList> groups = {
    {"GRP_fs_access", { "open", "close", "stat", "fstat", "lstat", "newfstatat", "access", "faccessat", 
        ...
        "mount", "rename", "renameat", "renameat2", "link", "linkat", "symlink", "symlinkat"}}, 
